...
bench_single_verify!(bench_single_verify_64, 64);
bench_single_verify!(bench_single_verify_128, 128);
bench_single_verify!(bench_single_verify_256, 256);
bench_single_verify!(bench_single_verify_512, 512);
bench_single_verify!(bench_single_verify_1024, 1024);

criterion_group!(
    benches,
    bench_single_verify_64,
    bench_single_verify_128,
    bench_single_verify_256,
    bench_single_verify_512,
    bench_single_verify_1024
);
